...
//
//import static com.breaditnow.common.exception.CustomerErrorCode.QUANTITY_POSITIVE;
...
//            int quantity = 3;
//
//            ReservationProduct products = new ReservationProduct(1L, "식빵", "image.jpg", price, quantity);
//
...
//            Money price = new Money(1000);
//
//            assertThatThrownBy(() -> new ReservationProduct(1L, "식빵", "image.jpg", price, quantity))
...
//        int quantity = 2;
//
//        ReservationProduct products = new ReservationProduct(2L, "크루아상", "croissant.jpg", price, quantity);
//
