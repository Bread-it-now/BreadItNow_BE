package com.breaditnow.alert.infrastructure.jpa.entity;
...
public class QGlobalAlertSettingEntity extends EntityPathBase<GlobalAlertSettingEntity> {
    ...
    private static final long serialVersionUID = 1637095399L;
    ...
    public final SimplePath<com.breaditnow.alert.domain.DayOfWeekSet> days = createSimple("days", com.breaditnow.alert.domain.DayOfWeekSet.class);

    public final ComparablePath<com.breaditnow.common.domain.DailyTime> endTime = createComparable("endTime", com.breaditnow.common.domain.DailyTime.class);

    public final ComparablePath<com.breaditnow.common.domain.DailyTime> startTime = createComparable("startTime", com.breaditnow.common.domain.DailyTime.class);
