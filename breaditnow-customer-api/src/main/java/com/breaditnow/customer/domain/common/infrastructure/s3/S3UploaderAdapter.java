package com.breaditnow.customer.domain.common.infrastructure.s3;
...
import static com.breaditnow.customer.global.exception.CustomerErrorCode.FILE_CREATION_FAILED;
import static com.breaditnow.customer.global.exception.CustomerErrorCode.FILE_UPLOAD_FAILED;
...
public class S3UploaderAdapter implements ImageStoragePort {
    ...
    public String upload(MultipartFile multipartFile, String dirName) {
        File localFile = convertToFile(multipartFile)
                .orElseThrow(() -> new CustomerException(FILE_CREATION_FAILED));
    ...
    private Optional<File> convertToFile(MultipartFile multipartFile) {
        ...
        try {
            ...
            throw new CustomerException(FILE_UPLOAD_FAILED, e);
        }
