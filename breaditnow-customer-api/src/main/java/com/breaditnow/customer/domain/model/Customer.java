package com.breaditnow.customer.domain.model;
...
import static com.breaditnow.common.exception.CustomerErrorCode.INVALID_NICKNAME;
import static com.breaditnow.config.RabbitMQConfig.PASSWORD_CHANGE_ROUTING_KEY;
...
public class Customer {
    ...
    public void updateInfo(String nickname, String phone, String newPassword, MultipartFile profileImage, SaveImageStoragePort saveImageStoragePort, PublishEventPort publishEventPort) {
        ...
        saveProfileImage(saveImageStoragePort, profileImage);
    }

    public void saveProfileImage(SaveImageStoragePort saveImageStoragePort, MultipartFile profileImageUrl) {
        if (profileImageUrl != null) {
            this.profileImageUrl = saveImageStoragePort.upload(profileImageUrl, "image/customer/" + getId() + "/profile");
        }
    }
}
