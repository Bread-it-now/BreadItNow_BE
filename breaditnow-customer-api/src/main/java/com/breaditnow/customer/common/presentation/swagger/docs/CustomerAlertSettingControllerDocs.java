...
public interface CustomerAlertSettingControllerDocs {
	...
	ApiSuccessResponse<CustomerDoNotDisturbResponse> getDoNotDisturbSetting(Long customerId);
	...
	ApiSuccessResponse<Void> updateDoNotDisturbSetting(Long customerId, CustomerDoNotDisturbUpdateRequest request);
