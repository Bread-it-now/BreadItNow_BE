...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
	...
	private final OAuth2CustomerRegistrationService OAuth2CustomerRegistrationService;
	...
	public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
		...
		Customer customer = OAuth2CustomerRegistrationService.registerCustomer(oAuth2UserInfo);
