...
import com.breaditnow.auth.application.EmailAuthService;
import com.breaditnow.auth.application.EmailDuplicationService;
...
import com.breaditnow.common.swagger.docs.EmailControllerDocs;
...
public class EmailController implements EmailControllerDocs {
    ...
    public ApiSuccessResponse<Map<String, Boolean>> checkDuplicate(@RequestParam("email") @NotBlank(message = "이메일은 필수 항목입니다.") String email) {
