...
class ProductTest {
    ...
    void throwIfDeleted() {
        ...
        assertThatThrownBy(() -> deleted.updateDisplayOrder(2)).isInstanceOf(DomainException.class);
        assertThatThrownBy(() -> deleted.updateStock(1)).isInstanceOf(DomainException.class);
        assertThatThrownBy(() -> deleted.changeStatus(ProductStatus.FOR_SALE)).isInstanceOf(DomainException.class);
        ...
        assertThatThrownBy(deleted::delete).isInstanceOf(DomainException.class);
    }
