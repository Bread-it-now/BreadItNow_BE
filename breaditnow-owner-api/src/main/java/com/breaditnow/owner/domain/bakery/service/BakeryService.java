...
import static com.breaditnow.domain.domain.bakery.enumerate.OperatingStatus.CLOSED;
import static com.breaditnow.owner.global.exception.OwnerErrorCode.COORDINATE_NOT_FOUND;
...
public class BakeryService {
    ...
    public Long createBakery(Long ownerId, BakeryCreateRequest bakeryCreateRequest, MultipartFile profileImage) {
        ...
        AddressCoordinateDto addressCoordinate = geoLocationClient.lookupCoordinates(
                bakeryCreateRequest.address());
        if (addressCoordinate == null) {
            throw new OwnerException(COORDINATE_NOT_FOUND);
        }
        address.setLatitude(addressCoordinate.getLatitude());
        address.setLongitude(addressCoordinate.getLongitude());
    ...
    public BakeryResponse updateBakery(Long ownerId, Long bakeryId, BakeryUpdateRequest bakeryUpdateRequest,
        ...
        AddressCoordinateDto addressCoordinate = geoLocationClient.lookupCoordinates(bakeryUpdateRequest.address());
        if (addressCoordinate == null) {
            throw new OwnerException(COORDINATE_NOT_FOUND);
        }
        address.setLatitude(addressCoordinate.getLatitude());
