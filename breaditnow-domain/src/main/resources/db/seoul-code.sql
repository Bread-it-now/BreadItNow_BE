insert into region (region_code, sido_name, gugun_name, dong_name)
values ('1100000000', '서울특별시', '전체', '전체'),
       ('1111000000', '서울특별시', '종로구', '전체'),
